...
it("publishes the exact accepted answer with source and claim provenance, never the raw conversation", () => {
  const session = { id: "00000000-0000-4000-8000-000000000011", trainerAccountId: "trainer", conversationId: "conversation", targetRepository: "PointCommunity/pointaudio", originalQuestion: "How do I check sync?", state: "ACTIVE", currentAnswer: { id: "00000000-0000-4000-8000-000000000012", directAnswer: "Check cable before clock.", steps: ["Inspect cable."], confidence: "SUPPORTED", claims: [{ id: "claim", text: "Check cable.", status: "SUPPORTED", evidenceIds: ["source-1"] }], evidence: [{ id: "source-1", digest: "a".repeat(64), locator: "M32@abc; page 1" }] }, currentReport: null, proposalId: null, createdAt: "2026-09-15T00:00:00.000Z", updatedAt: "2026-09-15T00:00:00.000Z", version: 3 } satisfies TrainingSessionRecord;
