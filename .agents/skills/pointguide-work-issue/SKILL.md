---
name: pointguide-work-issue
description: "Select or implement one PointGuide GitHub Issue while enforcing the single-active-Issue pipeline. Use for Work Issue, Work Issue #N, starting Backlog work, or continuing the active implementation."
---

# Work a PointGuide Issue

Read `AGENTS.md`, `.agents/pointguide-pipeline-policy.html`, the live Project, all active cards, the Issue, open PRs, Git state, and relevant code before acting.
...
7. Hand off directly to `pointguide-review-issue`; do not move to In Review merely because a PR exists.
