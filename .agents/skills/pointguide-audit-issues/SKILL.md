---
name: pointguide-audit-issues
description: "Audit and correct prioritization and metadata for PointGuide Backlog Issues only. Use when the PM asks to audit, reprioritize, clean up, or validate the backlog."
---

# Audit the PointGuide Backlog

Read `AGENTS.md`, `.agents/pointguide-pipeline-policy.html`, the live Project fields, every Backlog Issue, and relevant duplicate or dependency evidence.
