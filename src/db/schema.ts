...
export const answers = pgTable("answers", {
  ...
  acceptedGuidance: jsonb("accepted_guidance").$type<Readonly<Record<string, unknown>>[]>().notNull().default([]),
...
export const trainingSessions = pgTable("training_sessions", {
  ...
  acceptedPath: text("accepted_path"),
  acceptedSourceVersion: integer("accepted_source_version"),
